# uHexen2 Build System - Convenience Makefile
# This provides convenient targets for common build tasks

.PHONY: help build release clean nix-build nix-release nix-linux nix-win32 nix-win64

help:
	@echo "uHexen2 Build Targets"
	@echo "===================="
	@echo ""
	...
	@echo "  make nix-win32      - Build Windows 32-bit only"
...
nix-win32:
	nix build .#win32 --print-build-logs
